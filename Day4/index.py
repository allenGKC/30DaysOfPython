...
# 5. Print the length of the company string using len() function.
print(len(company))

# 6. Change all the characters to uppercase using upper() function.
print(company.upper())

# 7. Change all the characters to lowercase using lower() function.
print(company.lower())
...
print('PFE'.join(company.split()[0:3]))
...
print(' '.join('You cannot end a sentence with because because because is a conjunction'.split()[6:9]))
